...
#Model for AKI patients arriving to ICU with pre-existing stage 2+ AKI, who it is assumed would not recieve the new tests as they cannot benefit from early intervention
#These patients therefore experience the baseline transitions of AKI progression & recovery, and do not have the cost of the new test applied
...
#======================= TRANSITION PROBABILITY MATRIX ================================================================================================================
  ...
  trace [1,5,i]   <-  0
  trace [1,6,i]   <-  0          
  trace [1,7,i]   <-  start.S2.preAKI[i]   
  trace [1,8,i]   <-  start.S3.preAKI[i]
  trace [1,9,i]   <-  start.RRT.preAKI[i]
  trace [1,10,i]  <-  0  
  trace [1,11,i]  <-  0    
  trace [1,12,i]  <-  0 
  trace [1,13,i]  <-  0
